...
3. **Build** - deliver the smallest useful, secure product that meets the mandate.
4. **Verify** - test function, experience, security, and launch readiness.
5. **Launch** - publish with positioning, onboarding, analytics, and support.
6. **Operate** - measure results, maintain the product, and propose the next decision.
...
An approved initiative should expose:
...
Small implementation choices belong to the accountable delivery team. Changes that materially alter cost, purpose, risk, or promised outcomes should return to governance or the authorized review path.

**Next:** [Treasury and value flow](treasury-and-value.md)
