...
Delegation lets a holder assign voting power without transferring token ownership, when supported by the governance system. Choose a delegate based on public reasoning, participation, expertise, disclosure practices, and alignment—not promised rewards.

Delegation should be revocable. Holders remain responsible for monitoring the delegate and the live rules.
